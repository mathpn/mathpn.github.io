...
More formally, both Gini impurity and entropy are strictly [concave fuctions](https://en.wikipedia.org/wiki/Concave_function).
...
![Animation of single split choice](../../assets/images/climbing-trees-1/decision_tree_split.gif)
...
- [Bias-Variance Analysis: Theory and Practive](https://cs229.stanford.edu/summer2019/BiasVarianceAnalysis.pdf) - Stanford CS229 (Summer 2019) lecture notes
