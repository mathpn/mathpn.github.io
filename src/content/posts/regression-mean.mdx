...
import no_corr from "@assets/images/regression_mean/no_correlation_scatter_plot.png";

<Image
  src={no_corr}
  alt="Scatter plot of points of two dart throws showing no correlation"
  width="400"
/>
...
import perf_corr from "@assets/images/regression_mean/perfect_correlation_scatter_plot.png";

<Image
  src={perf_corr}
  alt="Scatter plot showing perfect correlation between two measurements"
  width="400"
/>
